...
const Home_net_binnen = ({ blok }) => (
  <div className="relative w-full px-4" {...storyblokEditable(blok)}>
    ...
    <p className="hoofdartikel_accent font-montserrat text-xs font-normal pt-5 ml-2">{blok.hoofdartikel_accent}</p>
 {/* Hoofdartikel titel met DM Sans font en 20px grootte */}
    ...
    <div className="mt-8 px-4">
      ...
      <div className="flex gap-4 mt-8">
        ...
        {/*Rechter tekst*/}
        <div className="w-1/2">
        <p className="font-montserrat text-xs font-normal pt-5 ml-2">{blok.netBinnen_accent_rechts}</p>
        <p className="font-dm-sans text-sm font-bold pt-2 ml-2 leading-5">{blok.netBinnen_titel_rechts}</p>
        </div>
      </div>
    </div>
  </div>
