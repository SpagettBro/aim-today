...
const EventsOverzicht = ({ blok }) => (
  <div
    className="max-w-screen-md mx-auto my-8 text-[#2a3a4b]"
        ...
        <div key={index} className="flex flex-col">
          ...
          >
            ...
            <div className="flex flex-col justify-between p-4 md:p-6 w-full md:w-2/3">
              ...
              <div className="mb-4">
                <h3 className="text-xl font-bold font-dm mb-1">
              ...
              <div className="mt-4">
                ...
                {/* Datum*/}
                <p className="flex items-center text-[#2a3a4b] font-semibold font-dm">
                  <svg
